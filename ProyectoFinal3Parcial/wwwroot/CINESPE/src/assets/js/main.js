...
class pelismario extends HTMLElement{
  constructor(){
      super();
  }
  connectedCallback(){
...
customElements.define("peli-mario",pelismario);

class pelisspiderman extends HTMLElement{
  constructor(){
      super();
  }
  connectedCallback(){
...
customElements.define("peli-spiderman",pelisspiderman);
